  ...
  <header class="absolute w-full z-30">
      ...
      <div class="flex items-center justify-between h-20">
        ...
        <nav class="hidden md:flex md:grow">
          ...
          <div class="flex items-center space-x-4">
            <span v-if="tokenDecoded" class="text-sm italic dark:text-gray-300">
              <router-link
                to="/account"
                class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out"
              >
        ...
        <div class="inline-flex md:hidden">
          ...
          >
            ...
            <svg
              class="w-6 h-6 fill-current text-gray-900 dark:text-gray-300"
              viewBox="0 0 24 24"
            >
    ...
    <transition name="slide">
      <nav
        ...
        id="mobile-nav"
        class="fixed top-0 h-screen z-20 left-0 w-full max-w-sm overflow-scroll bg-white dark:bg-gray-900 shadow-lg no-scrollbar"
      >
        <ul class="py-6 pr-4 pl-20">
          <li v-if="!token">
            <router-link
              to="/join"
              class="text-gray-600 dark:text-gray-300 py-2"
              >Join</router-link
            >
          </li>
          <li v-if="token">
