<template>
  <section class="bg-white bg-opacity-80 dark:bg-gray-800 dark:bg-opacity-50 h-screen">
...
<style>
/* Ensure that you have the Tailwind CSS file included in your project to apply these styles */
</style>